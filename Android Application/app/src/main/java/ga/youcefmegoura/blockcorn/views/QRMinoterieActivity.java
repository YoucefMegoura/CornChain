...
public class QRMinoterieActivity extends AppCompatActivity {
    private static final String TAG = "QRMinoterieActivity";
    ...
    private static final String SERVER_URL = SERVER_ADDRESS + "/minoterie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q_r_minoterie);
    ...
    public void submit(View view) {
        String keyTemperature = "temp1";
        String keyHumidity = "hum1";
        ...
        setPostRequest(productID, keyTemperature, productTemperature, keyHumidity, productHumidity);
    ...
    public void setPostRequest(String productId, String keyTemperature, String temperature, String keyHumidity, String humidity) {
